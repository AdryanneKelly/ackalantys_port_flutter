...
class ColorExtension extends ThemeExtension<ColorExtension> {
  ...
  ColorExtension copyWith() {
    ...
    return ColorExtension(
      ...
      startIconButttonColor: startIconButttonColor ?? this.startIconButttonColor,
      secondaryStartIconButtonColor: secondaryStartIconButtonColor ?? this.secondaryStartIconButtonColor,
      endIconButtonColor: endIconButtonColor ?? this.endIconButtonColor,
      secondaryEndIconButtonColor: secondaryEndIconButtonColor ?? this.secondaryEndIconButtonColor,
      titleSessionColor: titleSessionColor ?? this.titleSessionColor,
      contactSocialCardColor: contactSocialCardColor ?? this.contactSocialCardColor,
      primaryGradientTitleColor: primaryGradientTitleColor ?? this.primaryGradientTitleColor,
      secondaryGradientTitleColor: secondaryGradientTitleColor ?? this.secondaryGradientTitleColor,
